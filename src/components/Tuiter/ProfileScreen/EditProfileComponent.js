        ...
        return (
            <div>
                <div className="row">
                    ...
                    <div className="col-5 edit-profile-title" > Edit Profile</div>
                    <div className="col">
                ...
                <div className="row mt-2 pro-pics">
                    <img className= "banner-img" src={theInfo.bannerPicture}></img>
                    <span className="edit-banner-icons w-auto"><i className="fas fa-camera me-4"></i><i className="fas fa-times"></i></span>
                    <img className= "profile-img" src={theInfo.profilePicture}></img>
